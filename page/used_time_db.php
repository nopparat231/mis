...
if (isset($_POST['add'])) {
...
}elseif (isset($_POST['edit_used_time'])) {
	...
	WHERE used_time_user_id = '$used_time_user_id' ";
	...
	$sql =  "UPDATE used_time SET order_status = 1 WHERE used_time_user_id = '$used_time_user_id' ";
	if ($conn->query($sql) === TRUE) {
		header("location:../index.php?used_time");
	} else {
		echo "Error: " . $sql . "<br>" . $conn->error;
