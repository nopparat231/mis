							...
							<tbody>
								...
								while ($rowhuser = $qryhuser->fetch_array()) {
									$uid = $rowhuser['user_id'];
										...
										$sqlac = " SELECT * FROM f_action WHERE f_ac_user_c_id =  '$uid' AND f_ac_th_id = '$thid' ";
										...
										<tr>
											...
											if ($rowcheckac > 0) { ?>
												...
												<td>ทำแล้ว</td>
												<td width="5px"><a href="index.php?pa2&user_c_id=<?php echo ($rowhuser['user_id']) ?>&type=<?php echo($thid) ?>" target="_blank"><i class="fas fa-search"></i></a></td>
