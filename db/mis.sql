...
CREATE TABLE IF NOT EXISTS `arts_and_culture` (
...
CREATE TABLE IF NOT EXISTS `f_phhh` (
...
CREATE TABLE IF NOT EXISTS `kanzon` (
...
CREATE TABLE IF NOT EXISTS `kan_activity` (
...
CREATE TABLE IF NOT EXISTS `kan_research` (
...
CREATE TABLE IF NOT EXISTS `used_time` (
