...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2020 at 05:39 PM
...
INSERT INTO `user` (`user_id`, `first_name`, `last_name`, `username`, `password`, `user_tumn`, `user_kana_id`, `user_saka_id`, `user_head`, `user_status`) VALUES
(2, 'admin', 'admin', '443322', '123456', 'จนท.', 1, 2, 4, 1),
(3, 'Prasong', 'Ekaluck', '443323', '123456', 'จนท.', 1, 2, 4, 3),
(4, 'Traipoom', 'Chatwilai', '443324', '123456', 'พนง.', 1, 2, 4, 2),
(5, 'Traipoomppp', 'Chatwilaiiii', '443325', '123456', 'พนง.', 1, 2, 4, 0),
(6, 'Traip', 'Chat', '443326', '123456', 'พนง.', 1, 2, 11, 0),
(7, 'กหฟกาส่าส', 'พฟกาหสวาสว', '147852', '123456', 'ผู้ถูกประเมิน', 1, 2, 4, 0),
(8, 'สกวหฟสกหวสฟ', 'กฟหกฟสหก่าาส', 'test', '123456', 'ผู้ถูกประเมินทดสอบ', 1, 2, 4, 0),
...
CREATE TABLE `user_data` (
  ...
  `post code` varchar(6) NOT NULL,
  `faculty` varchar(100) NOT NULL,
  `department` varchar(100) NOT NULL,
  `branch` varchar(100) NOT NULL,
  `teaching disciplines` varchar(100) NOT NULL,
  `personnel type` varchar(100) NOT NULL,
  `sub-personnel type` varchar(100) NOT NULL,
  `academic position` varchar(100) NOT NULL,
  `administrative position` varchar(100) NOT NULL,
  `name of position` varchar(100) NOT NULL,
  `civil servant level` varchar(100) NOT NULL,
  `date of employment` varchar(20) NOT NULL,
  `term of employment` varchar(100) NOT NULL,
  `employment money` varchar(100) NOT NULL,
  `highest graduate level` varchar(100) NOT NULL,
  `course name` varchar(100) NOT NULL,
  `graduate disciplines` varchar(100) NOT NULL,
  `major graduate disciplines` varchar(100) NOT NULL,
  `graduate institution name` varchar(100) NOT NULL,
...
INSERT INTO `user_data` (`id`, `name`, `surname`, `sex`, `date of birth`, `nationality`, `house number`, `moo`, `road`, `district`, `area`, `province`, `phone`, `post code`, `faculty`, `department`, `branch`, `teaching disciplines`, `personnel type`, `sub-personnel type`, `academic position`, `administrative position`, `name of position`, `civil servant level`, `date of employment`, `term of employment`, `employment money`, `highest graduate level`, `course name`, `graduate disciplines`, `major graduate disciplines`, `graduate institution name`, `country of graduation`) VALUES
('3301300752779', 'ผศ. ดร. ภูริวัตร', 'คัมภีรภาพพัฒน์', 'ชาย', '16/07/2511', 'ไทย', '201/490', '2', '-', 'คลองถนน', 'สายไหม', 'กรุงเทพมหานคร', '02-2867005', '10220', 'คณะบริหารธุรกิจ', 'การตลาดและการจัดการ', 'ระบบสารสนเทศทางคอมพิวเตอร์', 'ระบบสารสนเทศทางคอมพิวเตอร์', 'ข้าราชการ', 'วิชาการ (มีหน้าที่สอน)', 'ผู้ช่วยศาสตราจารย์', 'หัวหน้าหน่วยงาน(คณะ)', 'ข้าราชการครู', 'ระดับ 8', '20/11/2534', 'ระยะเวลาจ้างงานมากกว่า 10 ปี', 'งบประมาณแผ่นดิน', 'ปริญญาเอก', 'ปร.ด. (เทคโนโลยีสารสนเทศ)', 'คอมพิวเตอร์', 'เทคโนโลยีสารสนเทศ', 'มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ', 'ไทย');
